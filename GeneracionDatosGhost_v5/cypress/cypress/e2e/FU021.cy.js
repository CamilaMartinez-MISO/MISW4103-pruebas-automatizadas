...
describe('FEATURE: Create Tags', function () {
    ...
    it("Scenario Random: Create a new Tag even with wrong Canonical Link", function () {
        const urlBase = 'https://'
    ...
    it("Scenario Random: Create a new Tag with a random Canonical Link", function () {
    ...
    it("Scenario Random: Validate that it's not possible create a new Tag with a long Meta Tile", function () {
    ...
    it("Scenario Random: Validate that it's not possible create a new Tag with a long Meta Description", function () {
        const fakeTitle = faker.lorem.word()
    ...
    it("Scenario Random: Validate that it's possible create a new Tag with a Meta Description not recommended", function () {
        const fakeTitle = faker.lorem.word()
    ...
    it("Scenario Psuedo: Validate that it's possible create a new Tag with a Meta Title not recommended", function () {
        const fakeTitle = faker.lorem.word()
    ...
    it("Scenario Psuedo: Validate that it's possible create a new Tag with a random Canonical Link", function () {
    ...
    it("Scenario Psuedo: Validate that it's not possible create a new Tag with a wrong Canonical Link", function () {
        const fakeTitle = faker.lorem.word()
        const urlBase = 'https://'
